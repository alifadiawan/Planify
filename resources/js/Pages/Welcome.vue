  ...
  <section class="bg-white dark:bg-gray-900">
    ...
    <div class="container px-6 py-16 mx-auto text-center">
      <div class="max-w-lg mx-auto">
        ...
        >
          Stay Organized, Stay On Track with Planify
        </h1>
        <p class="mt-6 text-gray-500 dark:text-gray-300">
            Simplify your tasks and collaborate seamlessly with a smart, intuitive task management tool designed for individuals and teams alike.
        </p>
        <button
